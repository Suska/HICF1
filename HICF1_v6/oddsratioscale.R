  ...
  if(a>=b){
    ...
    if (class(genclinv6[[a]]) == "factor" & class(genclinv6[[b]])=="factor"){
      ...
      # scale oddsratio for plot
       ...
       if(oddsratio>=0.1 & oddsratio < 0.2) { 
        oddsratio=-2
      }
       if(oddsratio>=0.2 & oddsratio < 0.4) { 
         oddsratio=-1
      }
       if(oddsratio>=0.6 & oddsratio < 0.8) { 
        oddsratio=0
      }
      if(oddsratio>=0.8 & oddsratio < 1) { 
        oddsratio=1
      }
       if(oddsratio>=1 & oddsratio < 3) { 
         oddsratio=2
       }
       if(oddsratio>=3 & oddsratio < 10) { 
        oddsratio=3
      }
      if(oddsratio>=10 & oddsratio < 15) { 
        oddsratio=4
      }
       if(oddsratio>=15 & oddsratio < 20) { 
        oddsratio=5
      }
      if(oddsratio>20) { 
        oddsratio=6
