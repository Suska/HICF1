...
oddsratio_abd <- function(a,b){
  ...
  if(a>=b){
    ...
    #this produces a matrix out of these counts
    countmatrix <- matrix(c(observedcount_1, expectedcount_1, observedcount_0, observedcount_1), nrow=2)
    library(abd)
    oddsratio <- odds.ratio(countmatrix)
